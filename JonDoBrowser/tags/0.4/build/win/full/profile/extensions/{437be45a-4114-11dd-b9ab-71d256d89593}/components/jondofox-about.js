//The following code allows a user to type about:jondobrowser into the browser bar
...
//We could do the registration of the about:jondobrowser as well without using JS 
...
//user would not be able to set about:jondobrowser as a startup page if she would
...
AboutJondofox.prototype = {
  newChannel : function(aURI) {
    if (aURI.spec !== "about:jondobrowser") {
      return;
    }
    var ios = Cc["@mozilla.org/network/io-service;1"].
	      getService(Ci.nsIIOService);
    var channel = ios.
    newChannel("chrome://jondofox/content/jondobrowser-features.xhtml", null, null);
  ...
  contractID: "@mozilla.org/network/protocol/about;1?what=jondobrowser",
