...
# Replace Searchengines (please check!!!)
rm ./JonDoBrowser-en-US/Contents/MacOS/Firefox.app/browser/searchplugins/*.xml
cp searchplugins/common/*.xml /JonDoBrowser-en-US/Contents/MacOS/Firefox.app/browser/searchplugins/

# Add Germna search plugins (remove the line, if German JDB is working)
cp searchplugins/de/*.xml /JonDoBrowser-en-US/Contents/MacOS/Firefox.app/browser/searchplugins/
